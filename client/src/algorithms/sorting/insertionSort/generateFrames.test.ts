...
const testCases: TestCase[] = [
  ...
  },
  {
    ...
    validations: (frames) => {
      ...
      const shiftCount = lastFrame.variables?.shifts || 0;
      console.assert(shiftCount > 0, 'Should have shifts for reverse sorted array');
    },
  },
  {
...
function runTests(): void {
  console.log('Running Insertion Sort Frame Generator Tests...\n');
  ...
  testCases.forEach((testCase) => {
    try {
      ...
      const frames = generateInsertionSortFrames(testCase.input);
