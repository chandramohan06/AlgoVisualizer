...
const testCases: TestCase[] = [
  ...
  },
  {
    ...
    validations: (frames) => {
      ...
      const mergeCount = lastFrame.variables?.merges || 0;
      console.assert(mergeCount > 0, 'Should have merges for reverse sorted array');
    },
  },
  {
...
function runTests(): void {
  console.log('Running Merge Sort Frame Generator Tests...\n');
  ...
  testCases.forEach((testCase) => {
    try {
      ...
      const frames = generateMergeSortFrames(testCase.input);
