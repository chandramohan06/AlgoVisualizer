...
console.log("Element at index 2:", arr[2]);`,
    ...
    relatedProblems: [
      { title: 'Two Sum', difficulty: 'Easy', link: '/algorithms' },
      { title: 'Best Time to Buy and Sell Stock', difficulty: 'Easy', link: '/algorithms' },
      { title: 'Container With Most Water', difficulty: 'Medium', link: '/algorithms' },
    ],
...
print("Front:", l[0])`,
  ...
  constructor(val) { this.val = val; this.next = null; }
    ...
    relatedProblems: [{ title: 'Linked List Cycle', difficulty: 'Easy', link: '/algorithms' }],
...
console.log("Apple count:", map.get("Apple"));`,
    ...
    relatedProblems: [{ title: 'Subarray Sum Equals K', difficulty: 'Medium', link: '/algorithms' }],
